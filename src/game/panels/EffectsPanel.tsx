			...
			<Modal title="Effects">
				<div className="w-64">
					<div className="flex justify-between">
						...
						<span>{data.timeSpeed.toFixed(2)}</span>
					</div>
					<div className="flex justify-between">
						<span>Ability Bonus</span>
						<span>+{abilityBonus.toFixed(2)}</span>
					</div>
					<div className="flex justify-between mt-1 border-t border-zinc-700 pt-1">
						<span>Total</span>
						<span>{effective.toFixed(2)}</span>
					</div>
				</div>
			</Modal>
			<Modal title="Abilities">
